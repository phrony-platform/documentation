...
| **Example YAML** | [Sample manifests](/samples/manifests) — one **HITL** **Telegram** relay (**cat fact** from public HTTP + **API** trigger), with **inputs** and **`phrony.values.yaml`** next to the entry YAML in this documentation repository. |
