---
title: "Agent and versions"
description: "List agents and versions, fetch JSON details, and deploy or retract versions with phrony agent."
---

Agent commands use the same **Bearer** authentication as manifest commands (**`phrony login`** or **`PHRONY_ACCESS_TOKEN`**) and the same Phrony API surface as the rest of the CLI. See [Authentication](/packages/cli/authentication).
